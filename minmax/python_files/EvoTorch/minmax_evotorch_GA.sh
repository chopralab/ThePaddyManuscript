#!/bin/bash
#SBATCH --job-name=evotorch_optimization_11Dec_200pop_GA  # Job name
...
python minmax_evotorch_GA.py --generations 6 --repeats 100 --std_dev 0.2 --job_name "$SLURM_JOB_ID" --seed 42
#!/bin/bash
#SBATCH --job-name=gramacy_evotorch_10Jan25_250pop_paramplot_GA  # Job name
...
# Run the EvoTorch Python script with user-specified generations, repeats, and popsize
python gramacy_evotorch_GA.py --generations 10 --repeats 100 --popsize 250 --seed 42

#!/bin/bash
#SBATCH --job-name=gramacy_evotorch_10Jan25_250pop_k_EA  # Job name
...
# Run the EvoTorch Python script with user-specified generations and repeats
python gramacy_evotorch_EA.py --generations 10 --repeats 100 --popsize 250 --seed 42